...
- [x] 6.4 Add partial recovery and derivative-payment warning tests, including split salary liability schedules, full-recovery reversibility, semantic reordered multi-sheet discovery, exact one-pass descriptor reuse during recovery/derivative rescan, current-run vacation dependencies, nonfatal protected formulas with unrelated successful writes, disputed unallocated audit rows, unchanged unsupported recovery-timing indexation, preload/discovery call ceilings, lock fallback/contention, complete planned-audit-union restoration including validations, and rollback injection at derivative, registry, audit, and flush boundaries.
